//#region node_modules/@pusher/push-notifications-web/dist/push-notifications-esm.js
...
function doRequest(_ref) {
	var method = _ref.method, path = _ref.path, _ref$body = _ref.body, body = _ref$body === void 0 ? null : _ref$body, _ref$headers = _ref.headers, headers = _ref$headers === void 0 ? {} : _ref$headers, _ref$credentials = _ref.credentials;
	var options = {
		method,
		headers,
	...
	if (body !== null) {
		...
		options.headers = objectSpread({ "Content-Type": "application/json" }, headers);
	}
...
function _handleError() {
	_handleError = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee2(response) {
...
var TokenProvider = /* @__PURE__ */ function() {
	...
	createClass(TokenProvider, [{
		key: "fetchToken",
		value: function() {
			var _fetchToken = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee(userId) {
				var queryParams, encodedParams, options, response;
				return regenerator.wrap(function _callee$(_context) {
					while (1) switch (_context.prev = _context.next) {
						case 0:
							queryParams = objectSpread({ user_id: userId }, this.queryParams);
...
var DeviceStateStore = /* @__PURE__ */ function() {
	...
	createClass(DeviceStateStore, [
			...
			value: function connect() {
				...
				return new Promise(function(resolve, reject) {
					...
					request.onsuccess = function(event) {
						_this._dbConn = event.target.result;
						_this._readState().then(function(state) {
							return state === null ? _this.clear() : Promise.resolve();
						}).then(resolve);
					};
					request.onupgradeneeded = function(event) {
						event.target.result.createObjectStore("beams", { keyPath: "instance_id" });
					};
					request.onerror = function(event) {
						reject(new Error("Database error: ".concat(event.target.error)));
					};
				});
			}
		},
		...
		},
		{
			key: "_readProperty",
			value: function() {
				var _readProperty2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee(name) {
					var state;
					return regenerator.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							case 0:
							...
							case 2:
								...
								return _context.abrupt("return", null);
							case 5: return _context.abrupt("return", state[name] || null);
							case 6:
							case "end": return _context.stop();
						}
					}, _callee, this);
		...
		},
		{
			key: "_writeProperty",
			value: function() {
				var _writeProperty2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee2(name, value) {
					var state;
					return regenerator.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							case 0:
...
var version = "1.1.0";
var INTERESTS_REGEX = /* @__PURE__ */ new RegExp("^(_|\\-|=|@|,|\\.|;|[A-Z]|[a-z]|[0-9])*$");
...
var Client = /* @__PURE__ */ function() {
	function Client(config) {
		...
		if (instanceId === void 0) throw new Error("Instance ID is required");
		if (typeof instanceId !== "string") throw new Error("Instance ID must be a string");
		if (instanceId.length === 0) throw new Error("Instance ID cannot be empty");
		if (!("indexedDB" in window)) throw new Error("Pusher Beams does not support this browser version (IndexedDB not supported)");
		if (!window.isSecureContext) throw new Error("Pusher Beams relies on Service Workers, which only work in secure contexts. Check that your page is being served from localhost/over HTTPS");
		if (!("serviceWorker" in navigator)) throw new Error("Pusher Beams does not support this browser version (Service Workers not supported)");
		if (!("PushManager" in window)) throw new Error("Pusher Beams does not support this browser version (Web Push not supported)");
		if (serviceWorkerRegistration) {
			var serviceWorkerScope = serviceWorkerRegistration.scope;
			if (!window.location.href.startsWith(serviceWorkerScope)) throw new Error("Could not initialize Pusher web push: current page not in serviceWorkerRegistration scope (".concat(serviceWorkerScope, ")"));
		}
	...
	createClass(Client, [
		{
			key: "_init",
			value: function() {
				var _init2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee() {
					return regenerator.wrap(function _callee$(_context) {
						while (1) switch (_context.prev = _context.next) {
							case 0:
							...
							case 11: this._serviceWorkerRegistration = _context.sent;
							case 12:
								_context.next = 14;
							...
							case 22: this._userId = _context.sent;
							case 23:
							case "end": return _context.stop();
						}
					}, _callee, this);
		...
		},
		{
			...
			value: function() {
				var _resolveSDKState2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee2() {
					return regenerator.wrap(function _callee2$(_context2) {
						while (1) switch (_context2.prev = _context2.next) {
							case 0:
								_context2.next = 2;
		...
		},
		{
			...
			value: function() {
				var _detectSubscriptionChange2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee3() {
		...
		},
		{
			key: "getDeviceId",
			value: function() {
				var _getDeviceId = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee4() {
					var _this = this;
					return regenerator.wrap(function _callee4$(_context4) {
						while (1) switch (_context4.prev = _context4.next) {
							...
							case 2: return _context4.abrupt("return", this._ready.then(function() {
		...
		},
		{
			key: "getToken",
			value: function() {
				var _getToken = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee5() {
					var _this2 = this;
					return regenerator.wrap(function _callee5$(_context5) {
						while (1) switch (_context5.prev = _context5.next) {
							case 0:
								_context5.next = 2;
								return this._resolveSDKState();
							case 2: return _context5.abrupt("return", this._ready.then(function() {
		...
		},
		{
			key: "getUserId",
			value: function() {
				var _getUserId = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee6() {
					var _this3 = this;
					return regenerator.wrap(function _callee6$(_context6) {
						while (1) switch (_context6.prev = _context6.next) {
							case 0:
								_context6.next = 2;
								return this._resolveSDKState();
							case 2: return _context6.abrupt("return", this._ready.then(function() {
		...
		},
		{
			...
			value: function _throwIfNotStarted(message) {
				if (!this._deviceId) throw new Error("".concat(message, ". SDK not registered with Beams. Did you call .start?"));
			}
		},
		{
			key: "start",
		...
		},
		{
			...
			value: function() {
				var _getRegistrationState = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee8() {
					return regenerator.wrap(function _callee8$(_context8) {
						while (1) switch (_context8.prev = _context8.next) {
							...
							case 8: return _context8.abrupt("return", RegistrationState.PERMISSION_PROMPT_REQUIRED);
							case 9:
		...
		},
		{
			...
			value: function() {
				var _addDeviceInterest = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee9(interest) {
					var path, options;
		...
		},
		{
			...
			value: function() {
				var _removeDeviceInterest = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee10(interest) {
					var path, options;
		...
		},
		{
			...
			value: function() {
				var _getDeviceInterests = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee11() {
					var path, options;
					return regenerator.wrap(function _callee11$(_context11) {
						while (1) switch (_context11.prev = _context11.next) {
							...
							case 7:
								...
								_context11.t0 = [];
							case 10: return _context11.abrupt("return", _context11.t0);
							case 11:
		...
		},
		{
			...
			value: function() {
				var _setDeviceInterests = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee12(interests) {
					...
					return regenerator.wrap(function _callee12$(_context12) {
						while (1) switch (_context12.prev = _context12.next) {
							...
							case 26: return _context12.finish(23);
							case 27: return _context12.finish(20);
							case 28:
								...
								options = {
									method: "PUT",
									path,
									body: { interests: uniqueInterests }
								};
								_context12.next = 33;
								return doRequest(options);
							case 33:
		...
		},
		{
			...
			value: function() {
				var _clearDeviceInterests = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee13() {
		...
		},
		{
			key: "setUserId",
			value: function() {
				var _setUserId = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee14(userId, tokenProvider) {
					...
					return regenerator.wrap(function _callee14$(_context14) {
						while (1) switch (_context14.prev = _context14.next) {
							...
							case 4:
								...
								error = /* @__PURE__ */ new Error(".start must be called before .setUserId");
							...
							case 16:
								...
								options = {
									method: "PUT",
									path,
									headers: { Authorization: "Bearer ".concat(beamsAuthToken) }
								};
								_context14.next = 21;
								return doRequest(options);
							case 21:
		...
		},
		{
			key: "stop",
			value: function() {
				var _stop = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee15() {
		...
		},
		{
			key: "clearAllState",
			value: function() {
				var _clearAllState = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee16() {
		...
		},
		{
			key: "_getPublicKey",
			value: function() {
				var _getPublicKey2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee17() {
					var path, options;
		...
		},
		{
			key: "_getPushToken",
			value: function() {
				var _getPushToken2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee18(publicKey) {
					var sub;
		...
		},
		{
			key: "_clearPushToken",
			value: function() {
				var _clearPushToken2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee19() {
					return regenerator.wrap(function _callee19$(_context19) {
						while (1) switch (_context19.prev = _context19.next) {
							case 0: return _context19.abrupt("return", navigator.serviceWorker.ready.then(function(reg) {
		...
		},
		{
			key: "_registerDevice",
			value: function() {
				var _registerDevice2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee20(token) {
		...
		},
		{
			key: "_deleteDevice",
			value: function() {
				var _deleteDevice2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee21() {
					var path, options;
		...
		},
		{
			...
			value: function() {
				var _updateDeviceMetadata2 = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee22() {
		...
		},
		{
			key: "_baseURL",
			get: function get() {
				if (this._endpoint !== null) return this._endpoint;
...
var validateInterestName = function validateInterestName(interest) {
	if (interest === void 0 || interest === null) throw new Error("Interest name is required");
	if (typeof interest !== "string") throw new Error("Interest ".concat(interest, " is not a string"));
	if (!INTERESTS_REGEX.test(interest)) throw new Error("interest \"".concat(interest, "\" contains a forbidden character. ") + "Allowed characters are: ASCII upper/lower-case letters, numbers or one of _-=@,.;");
	if (interest.length > MAX_INTEREST_LENGTH) throw new Error("Interest is longer than the maximum of ".concat(MAX_INTEREST_LENGTH, " chars"));
};
function getServiceWorkerRegistration() {
	return _getServiceWorkerRegistration.apply(this, arguments);
}
function _getServiceWorkerRegistration() {
	_getServiceWorkerRegistration = asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee23() {
		...
		return regenerator.wrap(function _callee23$(_context23) {
			while (1) switch (_context23.prev = _context23.next) {
				...
				case 6:
					window.navigator.serviceWorker.register(SERVICE_WORKER_URL, { updateViaCache: "none" });
...
function isSupportedBrowser() {
	...
	var isSupported = isChromium && vendorName === "Google Inc." && !isEdge && !isOpera || isOpera || isFirefox || isEdge;
	if (!isSupported) console.warn("Pusher Web Push Notifications supports Chrome, Firefox, Edge and Opera.");
	return isSupported;
}
//#endregion
